...
public abstract class AbstractClient {
    ...
    public final void run() {
        try {
            ...
            e.printStackTrace(); // 스텍구조로 예외를 추적하게 하는 부분을 출력
        } finally {
    ...
    // AbstractClient 상속받은 자식 클래스는 무조건 connectToServer() 메소드를 재정의 해야함
