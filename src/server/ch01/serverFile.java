...
public class serverFile {
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(5000)) {
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(input)); // 브릿지
            ...
            System.out.println("오류발생: 포트 5000번이 이미 사용중이거나 연결에 실패했습니다.");
        }
    } // end of main
} // end of class
